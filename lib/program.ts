...
export const SESSIONS: Record<string, TrainingSession> = {
  ...
  renfo_salle_a: {
    ...
    exercises: [
      ...
      { name: 'Pompes déclinées — haut pecs + épaules', detail: 'Pieds posés sur un banc (ou chaise), mains au sol à largeur d\'épaules. Le corps est incliné vers le bas. Cible le haut des pectoraux et les deltoïdes antérieurs. Plus dur que les pompes classiques — débuter par 3 × 6 et progresser.', sets: '50 au total', required: true },
      ...
      { name: 'Crunch câble (machine)', detail: 'À genoux face à la poulie haute, corde derrière la nuque, se contracter vers le bas en expirant. Plus de résistance qu\'au sol — progression en charge possible.', sets: '3 × 12 · charge légère' },
  ...
  bike_salle: {
    ...
    exercises: [
      ...
      { name: 'Pompes pike — épaules / deltoïdes', detail: 'En position de gainage, marcher les mains vers les pieds jusqu\'à former un V inversé (fesses en l\'air). Faire une pompe en amenant la tête vers le sol. Les épaules / deltoïdes font le travail. Si trop dur : commencer avec un V moins prononcé.', sets: '3 × 8 → 3 × 12' },
  ...
  bike_court_salle: {
    ...
    exercises: [
      ...
      { name: 'Pompes archer — pectoraux unilatéral', detail: 'En position de pompe large, descendre en décalant le poids vers un bras (l\'autre s\'étend sur le côté, légèrement fléchi). Alterner gauche/droite. Renforce chaque côté indépendamment et les stabilisateurs de la ceinture scapulaire. Version facile : genoux au sol.', sets: '3 × 6 / côté → 3 × 10 / côté' },
