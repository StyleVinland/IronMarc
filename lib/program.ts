...
export const SESSIONS: Record<string, TrainingSession> = {
  ...
  renfo_salle_b: {
    id: 'renfo_salle_b', label: 'Renfo Salle B — Haut du corps + MTSS', short: 'Salle B',
    type: 'renfo', color: '#AF52DE', duration: '60-70 min',
    desc: 'Jeudi · Pull + push haut du corps + protocole MTSS complet (soléaire, fessier moyen, tibial antérieur). Complément de Salle A lundi.',
    painCheck: true,
    exercises: [
...
export const PHASES: ProgramPhase[] = [
  // ── PHASE 1 : RÉÉDUCATION ─────────────────────────────────────────────────
  {
    ...
    focus: ['Salle A lun (Hölmich pubalgie)', 'Piscine mar + sam', 'Salle B mer (pull + MTSS)', 'Vélo salle jeu (Z2)'],
    template: {
      lun: 'renfo_salle_a', mar: 'swim_apprivoiser', mer: 'renfo_salle_b',
      jeu: 'bike_salle', ven: 'rest', sam: 'swim_apprivoiser', dim: 'rest',
    },
    notes: [
      'Zéro course à pied — le tibia et l\'aine se reconstruisent d\'abord en salle, sans impact.',
      'Lundi : protocole Hölmich Phase 1 (isométrie adducteurs). Jamais douloureux > 3/10.',
      'Mercredi : MTSS — soléaire + gastrocnémien + step-ups + hip hitches. Ce sont les exercices qui guérissent les périostites.',
      'Jeudi : vélo Zone 2 uniquement. Parler en phrases complètes = bonne intensité.',
      'Nage : objectif = entrer dans l\'eau et souffler dedans. Distance non comptée.',
    ],
  },
  {
    id: 'p1b',
    ...
    focus: ['Salle A lun (charge +2,5 kg/sem adducteurs)', 'Salle B mer (MTSS progression)', 'Marche ven si tibias OK', 'Nage 25 m planche'],
    template: {
      lun: 'renfo_salle_a', mar: 'swim_apprivoiser', mer: 'renfo_salle_b',
      jeu: 'bike_salle', ven: 'marche', sam: 'swim_apprivoiser', dim: 'rest',
    },
    notes: [
      'Critère marche : 20 min quotidiennes sans douleur tibiale depuis 1 semaine → alors vendredi.',
      'Salle A : passer adducteur machine (Hölmich Phase 2) si Phase 1 isométrique maîtrisée.',
      'Salle B : calf raises progression — une jambe à partir de S6 si 2 jambes maîtrisées.',
      'Vélo : augmenter de 5 min/semaine. S8 : viser 30 min Z2 continu.',
    ],
  },
  {
    id: 'p1c',
    ...
    focus: ['Run/walk 1:2 → 2:1 (tibias guidés)', 'Salle A+B : Copenhagen à partir S10', 'Vélo 35-40 min Z2 jeu', 'Nage crawl 10-25 m'],
    template: {
      lun: 'renfo_salle_a', mar: 'swim_debutant', mer: 'renfo_salle_b',
      jeu: 'bike_salle', ven: 'marche_course', sam: 'swim_debutant', dim: 'rest',
    },
    notes: [
      'Critère course : 30 min de marche sans douleur → seulement alors démarrer intervalles vendredi.',
      'Douleur tibiale le lendemain → semaine entière en marche. Pas de négociation.',
      'Salle A : introduire Copenhagen (Hölmich Phase 3) à S10 si S7-9 sans douleur à l\'aine.',
      'À partir de S13-14 : si un vélo est disponible, remplacer bike_salle par une sortie route.',
    ],
  },
