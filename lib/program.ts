...
export const SESSIONS: Record<string, TrainingSession> = {
  ...
  renfo_salle_a: {
    ...
    exercises: [
      ...
      { name: 'Vélo stationnaire — échauffement', detail: 'Cadence 80-90 RPM, résistance légère, 10 min. Activation hanches + mollets avant le travail adducteurs. Ne pas sauter l\'échauffement.', required: true },
      { name: 'Adduction isométrique — balle entre les genoux (Hölmich P1)', detail: 'Sur le dos, genoux fléchis à 90°, placer une balle ou coussin entre les genoux. Serrer doucement et maintenir. INDISPENSABLE en S1-4 ou si la machine adducteurs est douloureuse. La tendinopathie répond mieux à la charge progressive qu\'au repos.', sets: '5 × 10 maintiens × 10 sec · récup 90 s', warning: true },
      { name: 'Machine adducteurs — RAPPROCHER', detail: 'Amplitude contrôlée (pas en bout de course). Tempo 1 sec concentrique / 3 sec excentrique (lenteur = clé). Jamais de douleur > 3/10. S1-4 : charge minimale. +2,5 kg/semaine si totalement indolore.', sets: '3 × 12 · récup 60 s', warning: true },
      { name: 'Machine abducteurs — ÉCARTER', detail: 'Fessier moyen = stabilisateur du bassin. Un fessier moyen fort réduit le cisaillement de la symphyse pubienne lors des mouvements unilatéraux.', sets: '3 × 12' },
      { name: 'Leg press pieds écartés à la hauteur des épaules', detail: 'Pointes légèrement ouvertes, descendre à 90°. Force quadriceps sans compression directe de l\'aine. Pas de squat en phase aiguë (charge axiale sur symphyse).', sets: '3 × 10 · charge modérée, sans douleur à l\'aine' },
      { name: 'Leg curl machine — ischio-jambiers', detail: 'Allongé face au sol, résistance sur les chevilles, ramener les talons lentement. Chaîne postérieure = moteur du pédalage + protection du genou + soutien des périostites (absorbe les chocs à la place du tibia).', sets: '3 × 12' },
      { name: 'Hip thrust machine ou banc', detail: 'Dos appuyé sur un banc (ou machine dédiée), plaque ou barre sur les hanches. Pousser le bassin vers le haut en contractant les fessiers. Fessiers forts = puissance de pédalage + stabilité pelvienne = protection directe de la pubalgie.', sets: '3 × 10 · charge progressive (+5 kg/semaine)' },
      { name: 'Pompes déclinées — haut pecs + deltoïdes', detail: 'Pieds sur un banc, mains au sol à largeur d\'épaules. Corps incliné vers le bas. Vise 50 reps au total (exemple : 12+10+10+9+9). Le haut du corps push reste ici, le pull est jeudi (Salle B).', sets: '50 au total · démarrer à 3 × 6 s\'il le faut', required: true },
      { name: 'Sans matériel — gainage + pubalgie', detail: '', sets: '', section: true },
      { name: 'Copenhagen genou → pied (progressif)', detail: 'Planche latérale, jambe du dessus posée sur un banc. S1-6 : genou (version facile). S7+ : pied tendu si totalement indolore. Protocole Hölmich Phase 3 — ne pas introduire avant S7. Récupération 90 s entre les séries.', sets: '3 × 8 / côté · récup 90 s', warning: true },
      { name: 'Pont fessier unijambiste — Hölmich gainage', detail: 'Sur le dos, UN pied au sol genou fléchi, l\'autre jambe tendue ou fléchie en l\'air. Pousser le bassin vers le haut avec la jambe de soutien. Activation simultanée des fessiers + stabilisateurs pelviens. Clé du protocole Hölmich.', sets: '3 × 12 sec maintien / côté' },
      { name: 'Dead bug — gainage profond', detail: 'Sur le dos, bras vers le plafond, hanches et genoux à 90°. Étendre bras droit + jambe gauche simultanément sans creuser le dos. Dos collé au sol = gainage transverse = soutien de la symphyse pubienne.', sets: '3 × 8 / côté' },
      { name: 'Planche RKC (gainage haute tension)', detail: 'Sur les coudes, serrer les poings, contracter les fessiers et les abdos simultanément. Respiration normale. Substitut aux crunchs classiques qui sont contre-indiqués (traction sur les abdo bas = cisaillement pubien).', sets: '3 × 20 s · tension maximale' },
      { name: 'Mobilité', detail: 'Fente basse genou à terre 45 s / côté (psoas) · Pigeon couché 45 s / côté (fessier + aine) · Étirement adducteur allongé 30 s / côté.', required: true },
    ],
  },
  ...
  renfo_salle_b: {
    ...
    exercises: [
      ...
      { name: 'Adduction isométrique maintenance', detail: 'Allongé, balle entre les genoux, serrer et maintenir. Version maintenance (3 séries au lieu de 5 du lundi) — le but est de maintenir la charge et de ne pas laisser les adducteurs se relâcher entre les séances.', sets: '3 × 10 maintiens × 10 sec · récup 60 s', warning: true },
      { name: 'Pont fessier unijambiste — gainage pelvien', detail: 'Sur le dos, 1 pied au sol, pousser le bassin vers le haut. Maintien 12 sec. Active les stabilisateurs de la symphyse pubienne. 2 séries suffisent ici.', sets: '2 × 12 sec / côté' },
      ...
      { name: 'Step-ups sur box — MTSS tibias + fessiers', detail: 'Monter sur un step/banc en poussant sur le talon. 1 jambe à la fois. Progression : 20 cm (S1-4) → 30 cm (S5-8) → 40 cm (S9-16). Stimule le remodelage osseux du tibia de manière contrôlée. Chargement osseux progressif = traitement de fond des périostites.', sets: '3 × 12 / jambe · récup 60 s' },
      { name: 'Calf raises machine / barre — genou tendu (gastrocnémien)', detail: 'Descente excentrique lente 3 sec, montée rapide 1 sec. Priorité à la phase excentrique. Sur step si possible (pour amplifier le mouvement vers le bas). Gastrocnémien = muscle le plus directement responsable des périostites tibiales via la traction sur le périoste.', sets: '3 × 15 · récup 90 s · excentrique 3 sec impératif', warning: true },
      { name: 'Calf raises assis / soléaire — genou fléchi 90°', detail: 'Assis sur un banc ou machine soléaire, haltères sur les cuisses, genou à 90°. Soulever les talons. LE muscle le plus sous-entraîné dans les périostites. Le soléaire (profond) supporte 3× le poids du corps à la course — le renforcer réduit directement la traction sur le périoste tibial.', sets: '3 × 15 · récup 90 s', warning: true },
  ...
  renfo_salle_c: {
    ...
    exercises: [
      ...
      { name: 'Adduction debout élastique — Hölmich P2', detail: 'Élastique autour des chevilles (ou poulie basse), debout, ramener la jambe vers l\'autre en résistant à l\'élastique. Tempo 1 sec concentrique / 3 sec excentrique (la phase lente est la plus thérapeutique). C\'est la progression dynamique après l\'isométrie du lundi. Hölmich Phase 2 = passer de l\'iso à la charge dynamique légère.', sets: '5 × 10 / jambe · récup 90 s · 3 sec excentrique impératif', warning: true },
      { name: 'Planche latérale + abduction — Hölmich gainage avancé', detail: 'Gainage latéral sur le coude, lever la jambe du dessus à 30° et maintenir. Combine l\'activation du fessier moyen ET l\'oblique = stabilité pelvienne complète. Hölmich Phase 2 recommande ce gainage bimodal.', sets: '3 × 10 × 10 sec / côté' },
      { name: 'Avec matériel — composés + machines', detail: '', sets: '', section: true },
      { name: 'Vélo stationnaire — activation', detail: '8 min cadence légère. Troisième journée d\'affilée de sollicitation — activation uniquement, pas un échauffement complet.', required: true },
      { name: 'Romanian Deadlift haltères (RDL)', detail: 'Pieds à largeur des hanches, haltères devant les cuisses. Incliner le buste vers l\'avant en poussant les hanches en arrière, dos droit, descendre jusqu\'à la tension dans les ischio. Chaîne postérieure complète = moteur du pédalage.', sets: '3 × 10 · dos droit impératif, charge progressive' },
      { name: 'Bulgarian split squat (quadriceps unilatéral)', detail: 'Pied arrière posé sur un banc, pied avant à ~80 cm devant. Descendre le genou arrière vers le sol. Renforce les quadriceps de façon unilatérale = corrige les déséquilibres G/D + simule la foulée de course. Si douleur à l\'aine → réduire l\'amplitude.', sets: '3 × 8 / jambe · poids du corps S1-4, haltères à partir S5' },
      ...
      { name: 'Pallof press élastique (anti-rotation)', detail: 'Élastique accroché à un poteau ou rack à hauteur du nombril, de côté. Tenir l\'élastique à bout de bras devant soi et résister à la rotation. Le core résiste — il ne tourne pas. Anti-rotation = protection directe de la symphyse pubienne sous charge.', sets: '3 × 10 sec × 8 reps / côté' },
      { name: 'Planche avec rotation (T-planche)', detail: 'En position de pompe, ouvrir un bras vers le plafond, corps en T. Regard vers la main. Alterner G/D. Gainage latéral dynamique + deltoïdes + obliques.', sets: '3 × 8 / côté' },
      { name: 'Side plank + hip dip', detail: 'En gainage latéral sur le coude, laisser la hanche descendre vers le sol puis remonter. Fessier moyen + obliques + gainage latéral en même temps. Plus difficile que le side plank statique.', sets: '3 × 10 / côté' },
      { name: 'Pompes serrées (triceps + pectoraux internes)', detail: 'Mains sous les pectoraux (largeur des épaules ou moins). Coudes le long du corps en descendant. Variation différente des pompes déclinées du lundi.', sets: '3 × 10 → progression hebdomadaire' },
  ...
  bike_salle: {
    ...
    exercises: [
      ...
      { name: 'Zone 2 — endurance aérobie (SÉANCE PRINCIPALE)', detail: 'Cadence 80-90 RPM, résistance modérée. Test : tu peux parler par phrases complètes. Si tu souffles trop pour parler → trop fort. S1-4 : 25 min · S5-8 : 30 min · S9-12 : 35 min · S13-16 : 40 min. La Zone 2 développe la base aérobie = moteur de l\'Ironman. Plus tu en fais à ce stade, plus tes futurs entraînements seront efficaces.', required: true },
...
export const PHASES: ProgramPhase[] = [
  // ── PHASE 1 : RÉÉDUCATION ─────────────────────────────────────────────────
  {
    ...
    notes: [
      ...
      'Hölmich 3×/semaine : lun (lourd), mer (maintenance), ven (léger+élastique). C\'est le protocole validé pour guérir la pubalgie coriace en 8-12 semaines.',
  ...
  },
  {
    ...
    notes: [
      ...
      'Vélo : +5 min/semaine. Viser 30 min Z2 continu à S8.',
    ],
  },
  {
    id: 'p1c',
